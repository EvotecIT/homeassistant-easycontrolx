...
- Presence/activity-style signals derived from host state
- Better remote-session surfaces where they fit Home Assistant semantics
- Optional notification bridge if EasyControlX exposes it cleanly
- Additive per-volume, per-interface, and per-service entities where they fit
